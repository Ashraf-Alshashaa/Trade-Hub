...
def data(): 
    return [
        {'date': datetime(2024, 5, 14, 12, 34, 56, 789012), 'status': schemas.bid.BidStatus.ACCEPTED, 'product_id': 3, 'price': 112.34, 'bidder_id': 2},
        {'date': datetime(2024, 5, 15, 12, 34, 56, 789012), 'status': schemas.bid.BidStatus.PENDING, 'product_id': 7, 'price': 154.89, 'bidder_id': 2},
        {'date': datetime(2024, 5, 16, 12, 34, 56, 789012), 'status': schemas.bid.BidStatus.ACCEPTED, 'product_id': 1, 'price': 190.45, 'bidder_id': 2},
        {'date': datetime(2024, 5, 17, 12, 34, 56, 789012), 'status': schemas.bid.BidStatus.ACCEPTED, 'product_id': 5, 'price': 135.67, 'bidder_id': 4},
